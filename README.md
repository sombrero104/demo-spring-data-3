...
기존에 있던 트랜잭션을 이어갈 것인지, 아니면 기존에 있던 트랜잭션을 쓰지 않고  <br/>
새로운 트랜잭션을 만들어서 사용할 것인지를 설정. <br/>
...
콜백에는 @PrePersist, @PreRemove, @PostPersist, @PostRemove, @PreUpdate, @PostUpdate, @PostLoad가 있다. <br/>
